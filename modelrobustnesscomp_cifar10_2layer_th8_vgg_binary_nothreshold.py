def comp_cifar10_2layer_th8_vgg_binary(numberofcommon=0, repeat=1, datetime='0601', epsilons=8, stepsize=1, steps=8, numberofcommoncw=100):
    ...
    from model_building_2layer_th8_vgg_binary_nothreshold import Vgg16binary
    ...
    pathstring = '/mnt/ex/PycharmProjects/BinaryFeatures/dataset-cifar10-ablation/weiVGGBinaryModel'
    pathstring += datetime
    pathstring += '-2layer-th8-nothreshold-repeat'
    ...
    pathstring = '/mnt/ex/PycharmProjects/BinaryFeatures/dataset-cifar10-ablation/'
    namestring = 'weiVGGBinaryModel'
    namestring += datetime
    namestring += '-2layer-th8-nothreshold-repeat'
