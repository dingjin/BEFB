def comp_cifar10_2layer_th8_vgg_binary(numberofcommon=0, repeat=1, datetime='0601', epsilons=8, stepsize=1, steps=8, numberofcommoncw=100):
    ...
    pathstring = '/mnt/ex/PycharmProjects/BinaryFeatures/dataset-cifar10/weiVGGBinaryModel'
    pathstring += datetime
    pathstring += '-2layer-th8-repeat'
    pathstring += str(repeat)
    pathstring += '/my_checkpoint'
    model_binary = Vgg16binary()
    model_binary.load_weights(pathstring)
    #model_binary.training = False
    #model_binary.summary()
    pathstring1 = '/mnt/ex/PycharmProjects/BinaryFeatures/dataset-cifar10/weiVGGpureModel'
    ...
    namestring = 'weiVGGBinaryModel'
    namestring += datetime
    namestring += '-2layer-th8-repeat'
...
if __name__ == '__main__':
    ...
    comp_cifar10_2layer_th8_vgg_binary(numberofcommon=argv1, repeat=argv2, datetime=sys.argv[3], epsilons=argv4, stepsize=argv5, steps=argv6, numberofcommoncw=argv7)
