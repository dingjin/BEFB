def comp_2layer_th6_cifar10_resnet_binary(numberofcommon=0, repeat=1, datetime='0601', epsilons=8, stepsize=1, steps=8, numberofcommoncw=100):
    ...
    from model_building_2layer_th6_resnet_binary import ResNet34binary
    from CWattack import CarliniL2
    ...
    pathstring = '/mnt/ex/PycharmProjects/BinaryFeatures/dataset-cifar10/weiResNetBinaryModel'
    pathstring += datetime
    pathstring += '-2layer-th6-repeat'
    pathstring += str(repeat)
    pathstring += '/my_checkpoint'
    model_binary = ResNet34binary()
    model_binary.load_weights(pathstring)
    #model_binary.training = False
    #model_binary.summary()
    pathstring1 = '/mnt/ex/PycharmProjects/BinaryFeatures/dataset-cifar10/weiResNetpureModel'
    pathstring1 += datetime
    pathstring1 += '-repeat'
    pathstring1 += str(repeat)
    pathstring1 += '/my_checkpoint'

    model_binary1 = ResNet34()
    ...
    pathstring = '/mnt/ex/PycharmProjects/BinaryFeatures/dataset-cifar10-obfuscategra/'
    namestring = 'weiResNetBinaryModel'
    namestring += datetime
    namestring += '-2layer-th6-repeat'
...
if __name__ == '__main__':
    ...
    comp_2layer_th6_cifar10_resnet_binary(numberofcommon=argv1, repeat=argv2, datetime=sys.argv[3], epsilons=argv4, stepsize=argv5, steps=argv6, numberofcommoncw=argv7)
