...
class HParams(object):
    ...
    conv_filters = attr.ib(default=[64, 128, 512])
    ...
    adv_step_size = attr.ib(default=0.03)
...
def main(argv):
    ...
    base_model.load_weights('./weiVGGbinaryModel0521-AT/my_checkpoint')
    adv_model = base_model
    """
    #adv_model.load_weights('./weiVGGbinaryModel0521-AT/my_checkpoint')
    ...
    adv_model.base_model.save_weights('./weiVGGpureModel0521-AT/my_checkpoint')
    """
    base_model = build_base_model(hparams)
    ...
    """
    adv_accuracy, perturbed_images, labels, predictions = evaluate_robustness(base_model, adv_test_dataset, models,
                                       hparams)
