def comp_cifar10_2layer_th8_vgg_binary(numberofcommon=0, repeat=1, datetime='0601', epsilons=8, stepsize=1, steps=8, numberofcommoncw=100):
    ...
    from model_building_2layer_th8_vgg_binary_single import Vgg16binary
    ...
    pathstring = '/mnt/ex/PycharmProjects/BinaryFeatures/dataset-cifar10-single/weiVGGBinaryModel'
    pathstring += datetime
    pathstring += '-2layer-th8-single-repeat'
    ...
    namestring += datetime
    namestring += '-2layer-th8-single-repeat'
