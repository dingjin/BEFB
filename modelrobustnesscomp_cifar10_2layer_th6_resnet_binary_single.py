def comp_2layer_th6_cifar10_resnet_binary(numberofcommon=0, repeat=1, datetime='0601', epsilons=8, stepsize=1, steps=8, numberofcommoncw=100):
    ...
    from model_building_2layer_th6_resnet_binary_single import ResNet34binary
    ...
    pathstring = '/mnt/ex/PycharmProjects/BinaryFeatures/dataset-cifar10-single/weiResNetBinaryModel'
    pathstring += datetime
    pathstring += '-2layer-th6-single-repeat'
    ...
    pathstring = '/mnt/ex/PycharmProjects/BinaryFeatures/dataset-cifar10-single/'
    namestring = 'weiResNetBinaryModel'
    namestring += datetime
    namestring += '-2layer-th6-single-repeat'
