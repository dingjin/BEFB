def main_cifar_vgg_pure(epochs = 200, batchsize = 50, repeat = 1, datetime='0601'):
 ...
 #   model_V.save_weights('./weiVGGpureModel0210/my_checkpoint')
    return
...
if __name__ == '__main__':
    ...
    main_cifar_vgg_pure(epochs=argv1, batchsize=argv2, repeat=argv3, datetime=argv4)
    """
    argv1 = int(sys.argv[1])
    argv2 = int(sys.argv[2])
    argv3 = int(sys.argv[3])
    main_cifar_vgg_pure(epochs=argv1, batchsize=argv2, repeat = argv3, datetime=sys.argv[4])
